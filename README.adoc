...
* _testGenResumen()_ : Invoca al _stored procedure generarresumen()_ pasandole como parámetros el número del cliente y el período que se espera en el resumen.

* _generarcompras()_ : Inserta valores en la tabla compras, para que luego se pueda verificar las tablas cabecera y detalle, según lo generado por el resumen.
